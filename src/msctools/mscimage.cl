...
#			rangecheck=no, verbose=no)
		...
		# Make masks.
		if (pixmask) {
		    combine ("@"//pllist, pltemp//".pl",
			logfile="STDOUT", headers="", bpmasks=pl,
			rejmasks="", nrejmasks="", expmasks="", sigmas="",
			select="", group="", seqval="", seqgap=INDEF,
			extension="", delete=no,
		    ...
		    combine ("@"//extlist, out,
			logfile="STDOUT", headers="", bpmasks="",
			rejmasks="", nrejmasks="", expmasks="", sigmas="",
			select="", group="", seqval="", seqgap=INDEF,
			extension="", delete=no,
			combine="average", reject="none",
			outtype="real", outlimits="", offsets="wcs",
			masktype="badvalue", maskvalue="2", blank=blank,
			scale="none", zero="none", weight="none",
			...
			combine="average", reject="none",
			outtype="real", outlimits="", offsets="wcs",
			masktype="none", maskvalue="2", blank=blank,
			scale="none", zero="none", weight="none",
			statsec="", lthreshold=INDEF, hthreshold=INDEF,
			nlow=1, nhigh=1, nkeep=1, mclip=yes, lsigma=3.,
			hsigma=3., rdnoise="0.", gain="1.", snoise="0.",
