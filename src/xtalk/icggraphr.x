...
call eprintf ("icg_g1r: B\n")
	call gt_copy (gt, gt1)
call eprintf ("icg_g1r: C\n")
	call gt_sets (gt1, GTTYPE, "mark")
	call gt_sets (gt1, GTMARK, "cross")

call eprintf ("icg_g1r: D\n")
	if (IC_OVERPLOT(ic) == NO) {
	    # Start a new plot.

call eprintf ("icg_g1r: E\n")
	    call gclear (gp)

	    # Set the graph scale and axes.

call eprintf ("icg_g1r: F\n")
