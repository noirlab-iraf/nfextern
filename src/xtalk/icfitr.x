...
call eprintf ("ic_fit: D\n")
#call rcvcoeff (cv, coeff, ncoeff)
#call eprintf ("coeff=%g\n")
#call pargr (coeff)
#call eprintf ("ic_fit: D1\n")
		...
		if ((IC_LOW(ic) > 0.) || (IC_HIGH(ic) > 0.)) {
		    ...
		    IC_NREJECT(ic) = 0
call eprintf ("ic_fit: E\n")
	    }
	} then {
	    IC_FITERROR(ic) = YES
	    call erract (EA_ERROR)
	}
call eprintf ("ic_fit: F\n")
end
