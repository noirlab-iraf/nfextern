...
begin
	...
	call fprintf (fd, "define	ID_XPEAK	 3 # r pixels %%10.3f	/ X peak coordinate\n")
	call fprintf (fd, "define	ID_YPEAK	 4 # r pixels %%10.3f	/ Y peak coordinate\n")
	...
	call fprintf (fd, "define	ID_FRAC		33 # r """" %%8.3f		/ Apportioned fraction\n")
	call fprintf (fd, "define	ID_XMIN		34 # i pixels %%10.3f	/ Minimum X\n")
	call fprintf (fd, "define	ID_XMAX		35 # i pixels %%10.3f	/ Maximum X\n")
	call fprintf (fd, "define	ID_YMIN		36 # i pixels %%10.3f	/ Minimum Y\n")
	call fprintf (fd, "define	ID_YMAX		37 # i pixels %%10.3f	/ Maximum Y\n")
	call fprintf (fd, "define	ID_XAP		38 # r pixels %%10.3f	/ X aperture coordinate\n")
	call fprintf (fd, "define	ID_YAP		39 # r pixels %%10.3f	/ Y aperture coordinate\n")
	call fprintf (fd, "define	ID_X		40 # r pixels %%10.3f	/ X centroid\n")
	call fprintf (fd, "define	ID_Y		41 # r pixels %%10.3f	/ Y centroid\n")
	...
	call fprintf (fd, "define	ID_R		45 # r pixels %%8.3f	/ R moment\n")
	call fprintf (fd, "define	ID_RII		46 # r pixels %%8.3f	/ RI2 moment\n")
	call fprintf (fd, "define	ID_FWHM		47 # r pixels %%8.3f	/ FWHM estimate\n")
	call fprintf (fd, "define	ID_EAELLIP	48 # r """" """"		/ Ellip aperture ellipticity\n")
	call fprintf (fd, "define	ID_EATHETA	49 # r degrees %%8.2f	/ Ellip aperture pos angle\n")
	call fprintf (fd, "define	ID_EAR_0	50 # r pixels %%8.3f	/ Ellip aperture radius\n")
	call fprintf (fd, "define	ID_EAR_1	51 # r pixels %%8.3f	/ Ellip aperture radius\n")
	call fprintf (fd, "define	ID_EAR_2	52 # r pixels %%8.3f	/ Ellip aperture radius\n")
	call fprintf (fd, "define	ID_EAR_3	53 # r pixels %%8.3f	/ Ellip aperture radius\n")
	call fprintf (fd, "define	ID_EAR_4	54 # r pixels %%8.3f	/ Ellip aperture radius\n")
	call fprintf (fd, "define	ID_EAR_5	55 # r pixels %%8.3f	/ Ellip aperture radius\n")
	call fprintf (fd, "define	ID_EAR_6	56 # r pixels %%8.3f	/ Ellip aperture radius\n")
	call fprintf (fd, "define	ID_EAR_7	57 # r pixels %%8.3f	/ Ellip aperture radius\n")
	call fprintf (fd, "define	ID_EAR_8	58 # r pixels %%8.3f	/ Ellip aperture radius\n")
	call fprintf (fd, "define	ID_EAR_9	59 # r pixels %%8.3f	/ Ellip aperture radius\n")
	call fprintf (fd, "define	ID_EAFLUX_0	60 # r pixels %%10.3f	/ Ellip aperture flux\n")
	call fprintf (fd, "define	ID_EAFLUX_1	61 # r pixels %%10.3f	/ Ellip aperture flux\n")
	call fprintf (fd, "define	ID_EAFLUX_2	62 # r pixels %%10.3f	/ Ellip aperture flux\n")
	call fprintf (fd, "define	ID_EAFLUX_3	63 # r pixels %%10.3f	/ Ellip aperture flux\n")
	call fprintf (fd, "define	ID_EAFLUX_4	64 # r pixels %%10.3f	/ Ellip aperture flux\n")
	call fprintf (fd, "define	ID_EAFLUX_5	65 # r pixels %%10.3f	/ Ellip aperture flux\n")
	call fprintf (fd, "define	ID_EAFLUX_6	66 # r pixels %%10.3f	/ Ellip aperture flux\n")
	call fprintf (fd, "define	ID_EAFLUX_7	67 # r pixels %%10.3f	/ Ellip aperture flux\n")
	call fprintf (fd, "define	ID_EAFLUX_8	68 # r pixels %%10.3f	/ Ellip aperture flux\n")
	call fprintf (fd, "define	ID_EAFLUX_9	69 # r pixels %%10.3f	/ Ellip aperture flux\n")
	call fprintf (fd, "\n")
	...
	call fprintf (fd, "\n")
	call fprintf (fd, "define	ID_A		10001 # r pixels %%8.3f	/ Semimajor axis\n")
	call fprintf (fd, "define	ID_B		10002 # r pixels %%8.3f	/ Semiminor axis\n")
	call fprintf (fd, "define	ID_THETA	10003 # r degrees %%8.2f	/ Position angle\n")
	call fprintf (fd, "define	ID_ELONG	10004 # r """" """"		/ Elongation = A/B\n")
	call fprintf (fd, "define	ID_ELLIP	10005 # r """" """"		/ Ellipticity = 1 - B/A\n")
	call fprintf (fd, "define	ID_RR		10006 # r pixels %%8.3f	/ Second moment radius\n")
